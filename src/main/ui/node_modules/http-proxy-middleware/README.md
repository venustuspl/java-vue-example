...
v1.x.x ([release notes](https://github.com/chimurai/http-proxy-middleware/releases))
...
If you want to use the server's `app.use` `path` parameter to match requests; Create and mount the proxy without the
http-proxy-middleware `context` parameter:
