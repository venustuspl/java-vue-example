...
Vue.js supports all browsers that are [ES5-compliant](http://kangax.github.io/compat-table/es5/) (IE8 and below are not
supported).
...
For questions and support please use [the official forum](http://forum.vuejs.org)
