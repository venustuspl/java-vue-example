...
Note that the `events` module uses ES5 features. If you need to support very old browsers like IE8, use a shim
...
core `events` module will not be accepted. Feature requests should instead be directed
